...
function (_Component) {
  ...
  function ToolIndex() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = ToolIndex.__proto__ || Object.getPrototypeOf(ToolIndex)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
  ...
  _createClass(ToolIndex, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__components_layout__["a" /* default */], {
        ...
        person: this.state.data ? "visible" : "hidden",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 25
        }
...
//# sourceMappingURL=4.7eb9a482b877475b0241.hot-update.js.map